      ...
      <CardContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="employmentStatus" className="text-slate-200">
              Employment Status *
            </Label>
            <Select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="employer" className="text-slate-200">
                Employer/Company
              </Label>
              <Input
                id="employer"
          ...
          <div className="space-y-2">
            <Label htmlFor="annualIncome" className="text-slate-200">
              Annual Income (USD) *
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="netWorth" className="text-slate-200">
              Net Worth (USD) *
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="liquidNetWorth" className="text-slate-200">
          ...
          <div className="space-y-2">
            <Label htmlFor="incomeSource" className="text-slate-200">
          ...
          <div className="space-y-2">
            <Label htmlFor="expectedInvestment" className="text-slate-200">
